...
const FAMILY = {
  ...
  color: '#c8956c',
  accent: '#8B4513',
  desc: 'Trầm ấm và nam tính, hương gỗ gợi lên hình ảnh những khu rừng nguyên sinh bí ẩn. Từ gỗ đàn hương mềm mại đến trầm hương huyền bí — mỗi nốt hương là một hành trình vào thiên nhiên hoang dã.',
  notes: ['Gỗ đàn hương', 'Trầm hương', 'Gỗ tuyết tùng', 'Gỗ hồng', 'Patchouli'],
};

const PRODUCTS = [
  { id: 2,  name: 'Oud Mystique',      brand: 'LUXE SCENT', price: 4200000, wholesalePrice: 3360000, discount: 20, volume: '75ml',  image: '/images/San-Pham/SP2.jpg',  badge: 'Mới' },
  { id: 6,  name: 'Sandalwood Dream',  brand: 'LUXE SCENT', price: 3600000, wholesalePrice: 2700000, discount: 25, volume: '75ml',  image: '/images/San-Pham/SP6.jpg',  badge: 'Sale' },
  { id: 10, name: 'Santal 33',         brand: 'Le Labo',    price: 6800000, wholesalePrice: 5780000,              volume: '50ml',  image: '/images/San-Pham/SP10.jpg', badge: 'Mới' },
  { id: 14, name: 'Tobacco Vanille',   brand: 'Tom Ford',   price: 8150000, wholesalePrice: 6900000,              volume: '50ml',  image: '/images/San-Pham/SP14.jpg' },
  { id: 16, name: 'Oud Wood',          brand: 'Tom Ford',   price: 7500000, wholesalePrice: 6400000,              volume: '50ml',  image: '/images/San-Pham/SP16.jpg' },
];
...
export default function WoodyPage() {
  ...
  return (
    <>
      <LuxuryHeader />
      <main>
        <section style={{ background: 'linear-gradient(135deg, #fdf6f0 0%, #f5e6d3 50%, #ede0d0 100%)', padding: '80px 20px 60px', textAlign: 'center' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '28px' }}>
              {FAMILY.notes.map(n => (
                <span key={n} style={{ padding: '6px 16px', borderRadius: '999px', background: 'rgba(139,69,19,0.1)', color: FAMILY.accent, fontSize: '13px', fontWeight: '600' }}>{n}</span>
              ))}
            </div>
          </div>
        </section>
